...
import { ChevronLeft, Link2, ListChecks, ShieldCheck, Shield, Megaphone, Phone, ExternalLink, Monitor } from 'lucide-vue-next'
...
const nav = [
  ...
  { to: '/admin/quick-links', labelKey: 'admin.nav.quickLinks', icon: ExternalLink, enabled: true },
