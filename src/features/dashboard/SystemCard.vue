...
const href = computed(() => props.link.launchApp ? (props.link.downloadUrl || props.link.url) : props.link.url)
...
<template>
  <a :href="href" :target="link.openInNewTab ? '_blank' : '_self'" rel="noopener noreferrer" class="block" @click="onClick">
