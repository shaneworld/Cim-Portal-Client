...
export type EnumCategory = 'DEPARTMENT' | 'ROLE' | 'LINK_CATEGORY' | 'LINK_STATUS' | 'ANNOUNCEMENT_TYPE'
...
export interface HomeLink { id: number; nameZh: string; nameEn: string; url?: string; icon: string; statusCode: string; openInNewTab: boolean; environment?: 'DEV' | 'UAT' | 'RELEASE'; launchApp: boolean; downloadUrl?: string; accessible: boolean; favorite: boolean }
