...
export interface HomeLink { id: number; nameZh: string; nameEn: string; url?: string; icon: string; statusCode: string; openInNewTab: boolean; environment?: string; launchApp: boolean; downloadUrl?: string; accessible: boolean; favorite: boolean }
