...
export interface HomeLink { id: number; nameZh: string; nameEn: string; url: string; icon: string; statusCode: string; openInNewTab: boolean; environment?: 'DEV' | 'UAT' | 'RELEASE' }
